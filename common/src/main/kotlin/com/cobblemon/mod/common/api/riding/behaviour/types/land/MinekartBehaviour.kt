...
//        }
    ...
    override fun asMoLangValue(
        ...
        value.functions.put("drifiting") { DoubleValue(state.drifting) }
        value.functions.put("clockwise_drift") { DoubleValue(state.clockwiseDrift) }
        value.functions.put("boosting") { DoubleValue(state.boost) }
