...
import com.cobblemon.mod.common.entity.pokemon.ai.tasks.StopIfTiredOfTryingToReachSweetBerryBush
...
class StopIfTiredOfTryingToReachSweetBerryBushTaskConfig : SingleTaskConfig {
    ...
    override fun createTask(
        ...
        return StopIfTiredOfTryingToReachSweetBerryBush.create(100, 20*30)
    }
}